    ...
    return (
        <>
            <div className="py-20 w-full m-auto text-justify" id="services">
                <h1 className="text-4xl font-bold mb-10 text-center" id="about">Services</h1>
                <div className="flex">
                    <div className="shadow-md text-base m-8 rounded-lg pb-14">
                        <img src="images/upi.jpg" alt="" className="h-60 rounded-lg" />
                        <div className="  px-3">
                    ...
                    <div className="shadow-md text-base m-8 rounded-lg pb-14">
                        <img src="images/tracking.jpg" alt="" className="h-60 rounded-lg" />
                        <div className="  px-3">
                        <h1 className="text-xl font-bold pt-10 mb-5 text-orange-600 text-center" id="about">
